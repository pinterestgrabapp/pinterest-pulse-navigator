          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex gap-3 w-full sm:w-auto">
              ...
              <Button 
                ...
                className="gap-2 whitespace-nowrap bg-pinterest-red text-white"
              >
              ...
              <TableBody>
                {filteredHistory.map(item => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell className="max-w-[300px]">
                      <div className="flex flex-wrap gap-1">
                        {item.keywords.slice(0, 3).map((keyword, i) => (
                          <span key={i} className="inline-flex items-center rounded-full bg-gray-800 dark:bg-gray-800 px-2 py-0.5 text-xs text-gray-200 dark:text-gray-200">
                            {keyword}
                          </span>
                        ))}
                        {item.keywords.length > 3 && (
                          <span className="inline-flex items-center rounded-full bg-gray-800 dark:bg-gray-800 px-2 py-0.5 text-xs text-gray-200 dark:text-gray-200">
                    ...
                    <TableCell>
                      <span className="inline-flex items-center rounded-full bg-pinterest-red px-2 py-0.5 text-xs text-white font-medium">
                        {item.pinScore}
                      </span>
                    </TableCell>
                    <TableCell>
